...
Complementary ontology and pathway enrichment analyses of the AHBA-derived RA-specific, PA-specific, and shared gene sets were performed in Metascape using GO and Reactome annotations. RA-associated genes showed prominent enrichment for steroid/xenobiotic and proteostasis-related pathways, including ketosteroid monooxygenase activity (GO:0047086; fold enrichment = 366.95; p &lt; 0.001), together with strong enrichment for endoplasmic reticulum stress and protein quality-control processes, including response to unfolded protein (GO:0006986; fold enrichment = 20.55; p &lt; 0.001), cellular response to unfolded protein (GO:0034620; fold enrichment = 28.23; p &lt; 0.001), and response to topologically incorrect protein (GO:0035966; fold enrichment = 17.71; p &lt; 0.001). RA genes were also enriched for cytoskeletal signaling, including RHO GTPases activate CIT (R-HSA-5625900; fold enrichment = 81.54; p &lt; 0.001). In contrast, PA-associated genes preferentially implicated vascular and lipid-responsive processes, with enrichment for regulation of endothelial cell apoptotic process (GO:2000351; fold enrichment = 40.77; p &lt; 0.001) and cellular response to lipid (GO:0071396; fold enrichment = 6.34; p &lt; 0.001), alongside broader developmental annotations including sensory system development (GO:0048880; fold enrichment = 2.49; p &lt; 0.01) and visual system development (GO:0150063; fold enrichment = 2.32; p &lt; 0.01). Finally, the shared RA-PA gene set showed a comparatively stronger synaptic and excitability-related enrichment profile, including potassium channel complex (GO:0034705; fold enrichment = 16.49; p &lt; 0.001) and synaptic organization pathways, including positive regulation of synapse assembly (GO:0051965; fold enrichment = 16.43; p &lt; 0.001) and Neurexins and neuroligins (R-HSA-6794361; fold enrichment = 20.77; p &lt; 0.001), consistent with convergence on synaptic architecture and ion-channel-related mechanisms across aggression subtypes.
